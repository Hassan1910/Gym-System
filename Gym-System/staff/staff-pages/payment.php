...
<th>Remind</th> -->
      ...
      <tbody> 
          ...
          <td><div class='text-center'><?php echo 'KSH:'.$row['amount']?></div></td>
          <td><div class='text-center'><?php echo $row['services']?></div></td>
          <td><div class='text-center'><?php echo $row['plan']." Month/s"?></div></td>
         <!-- <td><div class='text-center'><a href='#?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class='icon icon-money'></i> Make Payment</button></a></div></td>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Developed By Hassan</a> </div>
</div>
