...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  ...
  <li class="<?php if($page=='messages'){ echo 'active'; }?>"><a href="message.php"><i class="icon icon-calendar"></i> <span>message</span></a></li>
  <li class="<?php if($page=='sms'){ echo 'active'; }?>"><a href="sms.php"><i class="icon icon-calendar"></i> <span>sms</span></a></li>
</div>
<!--sidebar-menu-->