  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg span3"> <a href="payment.php" style="font-size: 16px;"> <i class="fa fa-dollar-sign"></i> Total Earnings: KSH<?php include'income-count.php' ?></a> </li>
          ...
          <div class="row-fluid">
            ...
            <div class="span4">
              <ul class="site-stats">
                ...
                <li class="bg_ly"><i class="fas fa-file-invoice-dollar"></i> <strong>KSH<?php include 'actions/total-exp.php';?></strong> <small>Total Expenses</small></li>
