          ...
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block blue span8">(+254) 000-000-000</span> 
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  ...
                  Fitness <small>- ksh1500 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services" />
                  Sauna <small>- ksh1500 per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services" />
                  Cardio <small>- ksh1500 per month</small></label>
              </div>
            </div>
