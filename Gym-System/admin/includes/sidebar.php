<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  <ul>
    ...
    <ul>
      ...
      </li> <li class="<?php if($page=='mpesa'){ echo 'active'; }?>"><a href="mpesa.php"><i class="fas fa-tachometer-alt"></i> <span>mpesa</span></a> </li>
    </li> <li class="<?php if($page=='feedback'){ echo 'active'; }?>"><a href="feedback.php"><i class="fas fa-tachometer-alt"></i> <span>feedback</span></a> </li>
   <!-- </li> <li class="<?php if($page=='addCourses'){ echo 'active'; }?>"><a href="addcourses.php"><i class="fas fa-tachometer-alt"></i> <span>addcourses</span></a> </li>-->
