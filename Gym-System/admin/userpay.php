                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #GMS_<?php echo(rand(100000,10000000));?> <br> 5021  Meru Town, <br>Kenya </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
                                                            ...
                                                            <td>
                                                                <table class="invoice-items" cellpadding="0" cellspacing="0">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="alignright"><?php echo 'KSH:'.$amount?></td>
                                                                    </tr>
                                                                   
                                                                    
                                                                    <tr class="total">
                                                                        <td class="alignright" width="80%">Total Amount</td>
                                                                        <td class="alignright">KSH:<?php echo $amountpayable; ?></td>
                                                                    </tr>
                                                                </tbody></table>
                                                            </td>
                                                        </tr>
